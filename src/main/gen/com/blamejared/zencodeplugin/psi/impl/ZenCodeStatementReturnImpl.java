...
public class ZenCodeStatementReturnImpl extends ASTWrapperPsiElement implements ZenCodeStatementReturn {

  public ZenCodeStatementReturnImpl(@NotNull ASTNode node) {
    super(node);
  }
