...
public class ZenCodeStatementDoWhileImpl extends ASTWrapperPsiElement implements ZenCodeStatementDoWhile {

  public ZenCodeStatementDoWhileImpl(@NotNull ASTNode node) {
    super(node);
  }
