...
public class ZenCodeStatementTryCatchImpl extends ASTWrapperPsiElement implements ZenCodeStatementTryCatch {

  public ZenCodeStatementTryCatchImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZenCodeVisitor visitor) {
    visitor.visitStatementTryCatch(this);
  }
