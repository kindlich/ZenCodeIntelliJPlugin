...
public class ZenCodeExpressionVariableImpl extends ASTWrapperPsiElement implements ZenCodeExpressionVariable {

  public ZenCodeExpressionVariableImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ZenCodeVariableName getVariableName() {
    return findNotNullChildByClass(ZenCodeVariableName.class);
  }
