...
public class ZenCodeExpressionPanicImpl extends ASTWrapperPsiElement implements ZenCodeExpressionPanic {

  public ZenCodeExpressionPanicImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZenCodeVisitor visitor) {
    visitor.visitExpressionPanic(this);
  }
