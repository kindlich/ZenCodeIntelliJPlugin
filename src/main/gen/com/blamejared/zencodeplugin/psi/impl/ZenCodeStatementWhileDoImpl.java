...
public class ZenCodeStatementWhileDoImpl extends ASTWrapperPsiElement implements ZenCodeStatementWhileDo {

  public ZenCodeStatementWhileDoImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZenCodeVisitor visitor) {
    visitor.visitStatementWhileDo(this);
  }
