...
public class ZenCodeStatementSwitchImpl extends ASTWrapperPsiElement implements ZenCodeStatementSwitch {

  public ZenCodeStatementSwitchImpl(@NotNull ASTNode node) {
    super(node);
  }
