...
public class ZenCodeStatementBreakImpl extends ASTWrapperPsiElement implements ZenCodeStatementBreak {

  public ZenCodeStatementBreakImpl(@NotNull ASTNode node) {
    super(node);
  }
