...
public class ZenCodeAssignOperatorImpl extends ASTWrapperPsiElement implements ZenCodeAssignOperator {

  public ZenCodeAssignOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
