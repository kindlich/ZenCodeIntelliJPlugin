...
public class ZenCodeShiftOperatorImpl extends ASTWrapperPsiElement implements ZenCodeShiftOperator {

  public ZenCodeShiftOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
