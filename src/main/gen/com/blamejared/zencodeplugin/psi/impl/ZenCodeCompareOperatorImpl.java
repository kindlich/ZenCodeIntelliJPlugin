...
public class ZenCodeCompareOperatorImpl extends ASTWrapperPsiElement implements ZenCodeCompareOperator {

  public ZenCodeCompareOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
