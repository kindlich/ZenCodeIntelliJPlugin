...
public class ZenCodeStatementBlockImpl extends ASTWrapperPsiElement implements ZenCodeStatementBlock {

  public ZenCodeStatementBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
