...
public class ZenCodeTypeArgumentsImpl extends ASTWrapperPsiElement implements ZenCodeTypeArguments {

  public ZenCodeTypeArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
