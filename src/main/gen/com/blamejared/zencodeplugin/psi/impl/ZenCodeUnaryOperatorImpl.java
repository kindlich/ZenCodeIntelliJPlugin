...
public class ZenCodeUnaryOperatorImpl extends ASTWrapperPsiElement implements ZenCodeUnaryOperator {

  public ZenCodeUnaryOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
