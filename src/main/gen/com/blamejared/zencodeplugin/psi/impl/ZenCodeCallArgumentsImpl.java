...
public class ZenCodeCallArgumentsImpl extends ASTWrapperPsiElement implements ZenCodeCallArguments {

  public ZenCodeCallArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
