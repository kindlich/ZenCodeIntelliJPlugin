...
public class ZenCodeExpressionBracketImpl extends ASTWrapperPsiElement implements ZenCodeExpressionBracket {

  public ZenCodeExpressionBracketImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZenCodeVisitor visitor) {
    visitor.visitExpressionBracket(this);
  }
