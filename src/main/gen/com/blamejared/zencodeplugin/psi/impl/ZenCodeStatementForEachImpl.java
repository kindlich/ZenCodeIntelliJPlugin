...
public class ZenCodeStatementForEachImpl extends ASTWrapperPsiElement implements ZenCodeStatementForEach {

  public ZenCodeStatementForEachImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZenCodeVisitor visitor) {
    visitor.visitStatementForEach(this);
  }
