...
public class ZenCodeExpressionBEPImpl extends ASTWrapperPsiElement implements ZenCodeExpressionBEP {

  public ZenCodeExpressionBEPImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZenCodeVisitor visitor) {
    visitor.visitExpressionBEP(this);
  }
