...
public class ZenCodeSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public static final IElementType[] KEYWORD_ELEMENTS = new IElementType[]{K_ABSTRACT, K_ALIAS, K_AS, K_BOOL, K_BREAK, K_BYTE, K_CASE, K_CATCH, K_CHAR, K_CLASS, K_CONST, K_CONTINUE, K_DEFAULT, K_DO, K_DOUBLE, K_ELSE, K_ENUM, K_EXPAND, K_EXPORT, K_EXTERN, K_FALSE, K_FINAL, K_FINALLY, K_FLOAT, K_FOR, K_FUNCTION, K_GET, K_IF, K_IMMUTABLE, K_IMPLEMENTS, K_IMPLICIT, K_IMPORT, K_IN, K_INT, K_INTERFACE, K_INTERNAL, K_IS, K_LOCK, K_LONG, K_MATCH, K_NEW, K_NULL, K_OVERRIDE, K_PANIC, K_PRIVATE, K_PROTECTED, K_PUBLIC, K_RETURN, K_SBYTE, K_SET, K_SHORT, K_STATIC, K_STRING, K_STRUCT, K_SUPER, K_SWITCH, K_THIS, K_THROW, K_THROWS, K_TRUE, K_TRY, K_UINT, K_ULONG, K_USHORT, K_USIZE, K_VAL, K_VAR, K_VARIANT, K_VIRTUAL, K_VOID, K_WHILE};
